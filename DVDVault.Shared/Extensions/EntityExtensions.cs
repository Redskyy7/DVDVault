...
public static class EntityExtensions
{
    ...
    {
        var attribute = property.GetCustomAttribute(typeof(IfNullAttribute)) ?? throw new CustomAttributeNotDefineException($"Attribute for property wasn't defined.");
